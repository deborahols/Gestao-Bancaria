...
describe('Exclusão de Cadastro de pessoa', () => {
   ...
   beforeEach(() => {
      ...
      it('3- Validar exclusão de pessoa com conta vinculada', () => {

         cy.get('.text-red-600').first().click()
         cy.contains('Excluir').click()
         /*
         cy.contains('Não é possível excluir uma pessoa com conta vinculada').should('be.visible')
